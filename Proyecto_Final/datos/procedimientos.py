...
# Cuenta documentos emitidos de una empresa
def sp_contar_documentos_emitidos(id_empresa):
    ...
    try:
        cursor.execute("SET @total = 0")
        cursor.execute("CALL sp_contar_documentos_emitidos(%s, @total)", (id_empresa,))
...
# Cuenta documentos pendientes de una empresa
def sp_contar_documentos_pendientes(id_empresa):
    ...
    try:
        cursor.execute("SET @total = 0")
        cursor.execute("CALL sp_contar_documentos_pendientes(%s, @total)", (id_empresa,))
        cursor.execute("SELECT @total AS total")
        resultado = cursor.fetchone()
...
# Cuenta guías pendientes de una empresa
def sp_contar_guias_pendientes(id_empresa):
    ...
    try:
        cursor.execute("SET @total = 0")
        cursor.execute("CALL sp_contar_guias_pendientes(%s, @total)", (id_empresa,))
        cursor.execute("SELECT @total AS total")
        resultado = cursor.fetchone()
...
# Calcula stock total de productos de una empresa
def sp_stock_total_empresa(id_empresa):
    ...
    try:
        cursor.execute("SET @total_stock = 0")
        cursor.execute("CALL sp_stock_total_empresa(%s, @total_stock)", (id_empresa,))
...
# Calcula total de ventas de una empresa
def sp_total_ventas_empresa(id_empresa):
    ...
    try:
        cursor.execute("SET @total_ventas = 0")
        cursor.execute("CALL sp_total_ventas_empresa(%s, @total_ventas)", (id_empresa,))
...
def sp_contar_clientes_activos(id_empresa):
    ...
    try:
        cursor.execute("SET @total_clientes = 0")
        cursor.execute("CALL sp_contar_clientes_activos(%s, @total_clientes)", (id_empresa,))
