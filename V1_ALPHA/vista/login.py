...
# ============================================================================
# CREAR VENTANA DE LOGIN (función principal exportable)
# ============================================================================
def crear_ventana_login():
    """Crea y retorna la ventana de login sin ejecutar mainloop"""
    ...
    def iniciar_sesion():
        ...
        try:
            # Validar login
            exito, mensaje, datos_empresa = LoginBL.validar_login(usuario, ruc)
            
            if exito:
                messagebox.showinfo(
                    "✅ Éxito",
                    f"¡Bienvenido {datos_empresa['nombre']}!",
                    parent=ventana
                )
                
                # ✅ SOLUCIÓN: Destruir ventana de login y abrir dashboard
                ventana.destroy()
                
                # Importar y abrir dashboard
                from vista.index import abrir_dashboard
                abrir_dashboard(datos_empresa['nombre'], datos_empresa['id_empresa'])
    ...
    def mostrar_ventana_registro():
        ...
        try:
            from vista.registro import crear_ventana_registro
            ventana.destroy()
