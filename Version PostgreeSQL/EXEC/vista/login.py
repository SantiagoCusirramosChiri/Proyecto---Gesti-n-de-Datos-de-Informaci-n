...
def abrir_login():
    ...
    try:
        # Usamos el nuevo método para obtener la ruta compatible con .exe
        ruta_logo = ruta_recurso("recursos/simbolo.png")
        ...
        # Ícono alternativo si falla la imagen
    ...
    label_footer = ctk.CTkLabel(
        ventana,
        text="© 2025 IRONtomb - Todos los derechos reservados",
        font=("Arial", 9),
        text_color=COLOR_TEXTO_SECUNDARIO
    )
