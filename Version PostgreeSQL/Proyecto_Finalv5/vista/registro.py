# vista/registro.py - VERSIÓN CON LAYOUT CORREGIDO PARA BOTÓN + NUEVA
...
def abrir_registro(volver_al_login_callback):
    ...
    # ✅ FRAME UBICACIÓN CON GRID EN LUGAR DE PACK
    frame_ubicacion = ctk.CTkFrame(frame_scroll, fg_color="transparent")
    frame_ubicacion.pack(fill="x", pady=(0, 15))
    
    # Configurar grid con peso para que se ajuste
    frame_ubicacion.grid_columnconfigure(0, weight=1)  # ✅ Combo ocupa espacio disponible
    frame_ubicacion.grid_columnconfigure(1, weight=0)  # ✅ Botón tamaño fijo
    ...
    height=45,
    corner_radius=10,
    fg_color=COLOR_FONDO_TERCIARIO,  # Fondo del combo cerrado
    button_color=COLOR_ROJO_PRIMARY,  # Color de la flecha
    button_hover_color=COLOR_ROJO_HOVER,  # Hover de la flecha
    dropdown_fg_color="#FFFFFF",  # ✅ FONDO BLANCO para el dropdown
    dropdown_hover_color=COLOR_ROJO_PRIMARY,  # ✅ ROJO cuando pasas el mouse
    dropdown_text_color="#1a1a1a",  # ✅ TEXTO NEGRO en opciones
    text_color="#1a1a1a",  # Texto del combo cerrado
    font=("Arial", 12),
    state="readonly"
    )
    ...
    btn_nueva_ubicacion.grid(row=0, column=1, sticky="e")  # ✅ GRID EN LUGAR DE PACK
    
    # ============= FUNCIÓN REGISTRAR CON CONFIRMACIÓN =============
    def registrar_con_confirmacion():
        """Valida, confirma y registra la empresa"""
    ...
    # ============= FUNCIÓN VOLVER CON CONFIRMACIÓN =============
