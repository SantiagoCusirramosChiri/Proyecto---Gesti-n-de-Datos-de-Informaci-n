...
class RegistroBL:
    """
    Capa de Lógica de Negocio para Registro de Empresas.
    Maneja todas las operaciones relacionadas con el registro de empresas.
    """

    @staticmethod
    def obtener_ubicaciones_activas() -> Optional[List[Dict]]:
        """
        Obtiene todas las ubicaciones activas disponibles.
        
        Returns:
            List[Dict]: Lista de ubicaciones con id y descripción
        """
        db = ConexionDB()
        db.conectar()
    ...
    def validar_ubicacion_existe(id_ubicacion: int) -> Tuple[bool, str]:
        """
        Valida que una ubicación exista y esté activa.
        
        Args:
            id_ubicacion: ID de la ubicación a validar
    ...
    def registrar_empresa(nombre: str, razon_social: str, ruc: str, 
        ...
        """
        Registra una nueva empresa usando el procedimiento sp_registrar_empresa.
        
        Args:
            nombre: Nombre de la empresa
            razon_social: Razón social de la empresa
            ruc: RUC de 11 dígitos
            id_ubicacion: ID de la ubicación de la empresa
        
        Returns:
            Tuple[bool, str, Optional[int]]: (éxito, mensaje, id_empresa)
            - éxito: True si se registró correctamente, False si hubo error
            - mensaje: Mensaje descriptivo del resultado
            - id_empresa: ID de la empresa creada/reactivada, None si hubo error
        """
        ...
        try:
            ...
            # El SP retorna: (mensaje TEXT, id_empresa INTEGER)
            fila = resultados[0]
            ...
            if "ERROR" in mensaje.upper():
                ...
                # Cualquier otro mensaje no esperado
                return False, mensaje, id_empresa
    ...
    def validar_ruc_disponible(ruc: str) -> Tuple[bool, str]:
        """
        Verifica si un RUC está disponible para registro.
    ...
    def validar_razon_social(razon_social: str) -> Tuple[bool, str]:
        """
        Valida la razón social de la empresa.
    ...
    def insertar_ubicacion(descripcion: str) -> Tuple[bool, str, Optional[int]]:
        ...
        Args:
            descripcion: Descripción de la ubicación (ej: "Lima - Perú")
    ...
    def obtener_resultado_completo(nombre: str, razon_social: str, ruc: str, 
        ...
        """
        Registra una empresa y retorna un diccionario completo con el resultado.
        ...
        Returns:
            Dict con: {
                ...
                "tipo_operacion": str  # "creacion", "reactivacion", "existe", "error"
            }
            o None si hubo un error crítico
        """
