...
class ClienteBL:
    ...
    def obtener_clientes_activos() -> Optional[List[Dict]]:
        ...
        Returns:
            List[Dict]: Lista de clientes con sus datos completos
    ...
    def actualizar_cliente(id_cliente: int, nombre: str, apellido: str, 
        ...
        Args:
            ...
            id_identidad: ID de la identidad
    ...
    def insertar_cliente(nombre: str, apellido: str, 
        ...
        Returns:
            Tuple[bool, str, Optional[int]]: (éxito, mensaje, id_cliente)
        """
        # Validaciones
        if not nombre or not apellido:
    ...
    def insertar_identidad(tipo_identificacion: str, codigo_documento: str) -> Tuple[bool, str, Optional[int]]:
        """
        Inserta una nueva identidad (documento).
        
        Args:
            tipo_identificacion: Tipo de documento (DNI, PASAPORTE)
            codigo_documento: Número del documento
        
        Returns:
            Tuple[bool, str, Optional[int]]: (éxito, mensaje, id_identidad)
        """
    ...
    def buscar_o_crear_identidad(tipo_identificacion: str, codigo_documento: str) -> Tuple[bool, str, Optional[int]]:
        """
        Busca una identidad existente o crea una nueva.
