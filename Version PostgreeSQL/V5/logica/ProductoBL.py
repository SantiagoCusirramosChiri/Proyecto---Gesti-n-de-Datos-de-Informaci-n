...
class ProductoBL:
    ...
    def insertar_producto(nombre: str, descripcion: str, precio_base: float, 
        ...
        Returns:
            Tuple[bool, str, Optional[int]]: (éxito, mensaje, id_producto)
        """
        # Validaciones
    ...
    def actualizar_producto(id_producto: int, nombre: str, descripcion: str,
        ...
        Args:
            ...
            precio_base: Nuevo precio
            stock: Nuevo stock
            unidad_medida: Nueva unidad de medida
    ...
    def validar_precio(precio_str: str) -> Tuple[bool, str, Optional[float]]:
        ...
        Returns:
            Tuple[bool, str, Optional[float]]: (válido, mensaje, precio)
        """
    ...
    def validar_stock(stock_str: str) -> Tuple[bool, str, Optional[int]]:
        ...
        Returns:
            Tuple[bool, str, Optional[int]]: (válido, mensaje, stock)
        """
    ...
    def contar_productos_activos() -> int:
        ...
        Returns:
            int: Número de productos activos
        """
        productos = ProductoBL.obtener_productos_activos()
    ...
    def obtener_productos_combo() -> List[Dict]:
        """
        Obtiene productos en formato para ComboBox.
        
        Returns:
            List[Dict]: Lista de productos con formato simplificado
        """
        productos = ProductoBL.obtener_productos_activos()
