...
class StockBL:
    """
    Capa de Lógica de Negocio para Control de Stock.
    Maneja todas las operaciones relacionadas con inventario y stock de productos.
    """

    @staticmethod
    def obtener_productos_con_stock() -> Optional[List[Dict]]:
        """
        Obtiene todos los productos activos con su información de stock.
        
        Returns:
            List[Dict]: Lista de productos con datos completos
    ...
    def _calcular_nivel_stock(stock: int) -> str:
        """
        Calcula el nivel de stock del producto.
        
        Args:
            stock: Cantidad actual en stock
        
        Returns:
            str: 'AGOTADO', 'BAJO', 'NORMAL'
        """
        if stock <= 0:
            return 'AGOTADO'
        elif stock <= 25:
    ...
    def validar_cantidad(cantidad_str: str) -> Tuple[bool, str, Optional[int]]:
        ...
        Args:
            cantidad_str: Cantidad en formato string
        
        Returns:
            Tuple[bool, str, Optional[int]]: (válido, mensaje, cantidad)
        """
    ...
    def obtener_estadisticas_stock() -> Dict:
        ...
        Returns:
            Dict: Estadísticas de productos por nivel de stock
        """
        productos = StockBL.obtener_productos_con_stock()
    ...
    def obtener_historial_movimientos(id_producto: int) -> Optional[List[Dict]]:
        ...
        Returns:
            List[Dict]: Historial de movimientos o None si hay error
        """
        db = ConexionDB()
        db.conectar()
