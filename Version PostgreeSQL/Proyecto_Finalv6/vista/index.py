...
class SistemaApp:
    ...
    def _generar_menu(self):
        ...
        seccion_documentos.agregar_opcion("crear_documento", "Crear Comprobante", self.cargar_crear_documento)
        seccion_documentos.agregar_opcion("listar_documentos", "Listar Comprobantes", self.cargar_listar_documentos)
    ...
    def _crear_footer(self):
        ...
        label_footer = ctk.CTkLabel(
            frame_footer,
            text="© 2025 IRONtomb - Sistema de Gestión Empresarial | Todos los derechos reservados",
            font=("Arial", 10),
            text_color=COLOR_TEXTO_SECUNDARIO
        )
