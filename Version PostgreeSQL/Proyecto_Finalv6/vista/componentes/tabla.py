    ...
    def agregar_botones_accion(self, frame_fila, botones: list):
        ...
        for boton_info in botones:
            ...
            if len(boton_info) == 2:
                ...
                color_hover = COLOR_ROJO_PRIMARY
            elif len(boton_info) == 4:
                texto, comando, color_fg, color_hover = boton_info
            else:
                raise ValueError("Cada botón debe ser (texto, comando) o (texto, comando, color_fg, color_hover)")
