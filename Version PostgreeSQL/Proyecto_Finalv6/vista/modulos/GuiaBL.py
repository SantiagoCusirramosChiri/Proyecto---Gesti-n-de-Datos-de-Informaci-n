        ...
        try:
            ...
            for fila in resultados:
                guia = {
                    ...
                    'fecha_traslado': fila.get('fecha_inicio_traslado'),
                    'motivo_traslado': fila.get('motivo_traslado'),
                    'punto_partida': fila.get('direccion_partida'),  
                    'punto_llegada': fila.get('direccion_llegada'), 
        ...
        try:
            sql = """
                SELECT * FROM sp_insertar_detalle_guia(
                    ...
                    CAST(:transbordo AS VARCHAR(10)),
                    CAST(:categoria AS VARCHAR(10)),
                    CAST(:retorno AS VARCHAR(10)),
                    CAST(:vehiculo_vacio AS VARCHAR(10)),
                    :id_conductor,
                    :id_vehiculo
                )
            """
